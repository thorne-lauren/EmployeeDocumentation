            ...
            var supervisors = new Supervisor[]
{
            ...
            {
            new Documentation{EmployeeID=3699121,SupervisorID=9428541,Category=Category.MonthlyReview,Date=DateTime.Parse("2020-09-01"),Entry="Meredith had a very strong month. She exceeded her goals for ACW and received 3 customer kudos. She is also very helpful to her teammates around her and can always be counted on to be helpful"},
            new Documentation{EmployeeID=9636652,SupervisorID=6638120,Category=Category.MonthlyReview,Date=DateTime.Parse("2020-09-01"),Entry="Peggy is struggling in a number of areas so we made our focus this month on improving her customer satisfaction scores. I challenged her to give the customers a reason to leave her a postitive review"},
            new Documentation{EmployeeID=9636652,SupervisorID=6638120,Category=Category.DisciplinaryAction,Date=DateTime.Parse("2020-09-15"),Entry="Peggy used unprofessional language with a customer who wanted a price match. We went over appropriate ways to handle this type of situation."},
            new Documentation{EmployeeID=6634872,SupervisorID=6638120,Category=Category.Awards,Date=DateTime.Parse("2020-09-03"),Entry="At the recognition meeting, Yan received the #5 MVP award for overall performance."},
            new Documentation{EmployeeID=9698541,SupervisorID=8566741,Category=Category.Kudos,Date=DateTime.Parse("2020-09-02"),Entry="Cusotmer left a voicemail saying that Arturo went above and beyond for her and she throoughly enjoyed the phone call. Because of this experience she plans to shop with us again!"},
            new Documentation{EmployeeID=2566397,SupervisorID=3325890,Category=Category.Misc,Date=DateTime.Parse("2020-09-01"),Entry="Nino is hoping to get some time off around Thanksgiving. This is usually a busy season, but I agreed to work with Scheduling and see what we can do. Will follow up. "}
            };
